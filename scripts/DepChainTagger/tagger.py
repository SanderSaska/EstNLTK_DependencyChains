...
# TODO: Change Layer to RelationLayer. GitHub: https://github.com/estnltk/estnltk/blob/main/tutorials/system/relation_layer.ipynb
    ...
    def _make_layer(
        ...
        try:
            for i, sentence in enumerate(sentences_layer):
                ...
                sentence_syntax = layers.DEFAULT_SYNTAX_LAYER_NAME
