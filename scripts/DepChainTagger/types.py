...
# TODO: Add condition mode that checks if one keys in features match with the feats condition. Inclusion mode would be satisfied if at least one key matches, while exclusion mode would require that no keys match.
